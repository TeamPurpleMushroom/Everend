...
public class NEHoe extends HoeItem implements IEESpecialAbilityItem {
    private final EEItemAbility ability;

    public NEHoe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties, EEItemAbility ability) {
