...
import net.purplemushroom.everend.content.entities.BaseRift;
import org.jetbrains.annotations.NotNull;
import org.joml.Matrix3f;
import org.joml.Matrix4f;

import static net.purplemushroom.everend.client.registry.EERenderTypes.getRiftPortalRenderType;
import static net.purplemushroom.everend.client.registry.EERenderTypes.getVoidStarsTriRenderType;
...
public class BaseRiftRenderer<T extends BaseRift> extends Entity2DRenderer<T> {
    ...
    public BaseRiftRenderer(EntityRendererProvider.Context pContext, RiftType riftType) {
        ...
        riftCloudRenderType = RenderType.entityTranslucentCull(Everend.tl("entity/rift.png").fullLocation());
        riftCloudOutsideRenderType = RenderType.entityTranslucentCull(Everend.tl("entity/rift_outside.png").fullLocation());
