...
public class NEEntities {
    ...
    public static final EntityType<Gordon> GORDON_TYPE = ENTITIES.register("gordon", EntityType.Builder.of(Gordon::new, MobCategory.UNDERGROUND_WATER_CREATURE)).asPromised().get();
}
