...
public class ShifterineRod extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide()) {
            ...
            HitResult hitResult = ProjectileUtil.getEntityHitResult(player, vector1, vector2, player.getBoundingBox().inflate(50), (p_234237_) -> !p_234237_.isSpectator() && p_234237_.isPickable(), 40.0);
