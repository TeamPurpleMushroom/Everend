...
public class PlayerTracker extends PropertyContainer {
    ...
    private final CoffeeProperty<BlockPos> groundPos = prop("ground_pos", (BlockPos) null, PlayerLocationUtil.BlockPositionSerializer.INSTANCE).synced();
    private final CoffeeProperty<ResourceLocation> dimensionKey = prop("dimension", (ResourceLocation) null, PlayerLocationUtil.ResourceLocationSerializer.INSTANCE);
