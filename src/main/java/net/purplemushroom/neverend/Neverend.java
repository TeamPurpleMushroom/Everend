...
public class Neverend {
    public static final String
            MODID = "neverend",
            MOD_VERSION = "1.20.1-0.0.0.1",
            MOD_NAME = "Neverend",
            MOD_AUTHORS = "Dizzlepop12, DiamondWalker, TimeConqueror";
    public static final Logger LOGGER = LogManager.getLogger(MODID);
    public final Neverend INSTANCE;

    /** TODO: Remove this and create individual registry classes using TimeCore registry system.
    ...
    // TODO: Consolidate mod event bus listeners
    public Neverend() {
        INSTANCE = this;
